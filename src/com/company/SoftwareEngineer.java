 ...
 */
//The following class is a child of the application base class and manages a Software Engineer application
public class SoftwareEngineer extends Application{
    ...
    //in this case, 2 means we are at a software engineer object
    ...
    public boolean createQualifications(){
        ...
        newQualification("Can you design a high-performance storage system: ", 10);
        newQualification("Can you upkeep a high-performance storage system: ", 6);
        newQualification("Do you have experience in Software Engineering: ", 8);
        newQualification("Are you a good team player: ", 9);
        newQualification("Do you enjoy problem-solving: ", 5);
    ...
    public boolean saveApplication(){
        QualificationNode temp = head;
        String fileName = "SoftwareEngineerTemplate.txt";
